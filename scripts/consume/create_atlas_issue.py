...
# -*- coding: utf-8 -*-
"""
Create GitHub issue requesting atlas_fp_optical.csv publication.

This script prepares the issue content and prints the command to create it.
...
def main():
    print("=" * 60)
    print("Create GitHub Issue - Request atlas_fp_optical.csv")
    print("=" * 60)
    print()
    ...
    # Save to file
    issue_file = Path("reports/ISSUE_REQUEST.md")
    issue_file.parent.mkdir(exist_ok=True)
    
    with open(issue_file, 'w', encoding='utf-8') as f:
        f.write(body)
    
    print(f"[INFO] Issue body saved to: {issue_file}")
    print()
    ...
    print("=" * 60)
    print()
    print("To create the issue, run:")
    print()
    print(f'gh issue create \\')
    print(f'  --repo Mythmaker28/biological-qubits-atlas \\')
    print(f'  --title "{title}" \\')
    print(f'  --body-file reports/ISSUE_REQUEST.md \\')
    print(f'  --label "data,enhancement"')
    print()
    print("Or manually create at:")
    print("https://github.com/Mythmaker28/biological-qubits-atlas/issues/new")
    print()
    print("Attach files:")
    print("  - reports/WHERE_I_LOOKED.md")
    print("  - reports/DATA_REALITY_v1.1.4.md")
    print("  - reports/SUGGESTIONS.md")
    print()
    ...
    json_file = Path("reports/ISSUE_REQUEST.json")
    with open(json_file, 'w', encoding='utf-8') as f:
        json.dump(issue_data, f, indent=2)
    
    print(f"[INFO] Issue JSON saved to: {json_file}")
    print()
